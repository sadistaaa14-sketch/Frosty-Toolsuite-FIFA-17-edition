...
{
    public partial class DuplicateManagerWindow : FrostyDockableWindow
    {
        public string NewManagerName { get; private set; }
        public string DestinationPath { get; private set; }

        private readonly string sourceFolder;

        public DuplicateManagerWindow(string inSourceFolder)
        {
            InitializeComponent();
        ...
        private void DuplicateButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                FrostyMessageBox.Show("New manager name cannot be empty.", "Manager Duplicator");
                return;
            }

            if (newName.Contains("//") || newName.Contains(" "))
            {
                FrostyMessageBox.Show("Name contains invalid characters.", "Manager Duplicator");
                return;
            }
            ...
            {
                FrostyMessageBox.Show("New name must be different from the source.", "Manager Duplicator");
                return;
            }
            ...
            {
                FrostyMessageBox.Show("Select a destination folder in the tree.", "Manager Duplicator");
                return;
            }

            NewManagerName = newName;

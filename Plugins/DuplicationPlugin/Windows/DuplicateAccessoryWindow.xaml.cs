...
{
    public partial class DuplicateAccessoryWindow : FrostyDockableWindow
    {
        public string NewAccessoryName { get; private set; }
        public string DestinationPath { get; private set; }

        private readonly string sourceFolder;

        public DuplicateAccessoryWindow(string inSourceFolder)
        {
            InitializeComponent();
        ...
        private void DuplicateButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                FrostyMessageBox.Show("New accessory name cannot be empty.", "Accessory Duplicator");
                return;
            }

            if (newName.Contains("//") || newName.Contains(" "))
            {
                FrostyMessageBox.Show("Name contains invalid characters.", "Accessory Duplicator");
                return;
            }
            ...
            {
                FrostyMessageBox.Show("New name must be different from the source.", "Accessory Duplicator");
                return;
            }
            ...
            {
                FrostyMessageBox.Show("Select a destination folder in the tree.", "Accessory Duplicator");
                return;
            }

            NewAccessoryName = newName;

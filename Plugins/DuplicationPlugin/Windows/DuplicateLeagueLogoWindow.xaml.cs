...
{
    public partial class DuplicateLeagueLogoWindow : FrostyDockableWindow
    {
        public string NewLogoName { get; private set; }
        public string DestinationPath { get; private set; }

        private readonly string sourceFolder;

        public DuplicateLeagueLogoWindow(string inSourceFolder)
        {
            InitializeComponent();
        ...
        private void DuplicateButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                FrostyMessageBox.Show("New name cannot be empty.", "League Logo Duplicator");
                return;
            }

            if (newName.Contains("//") || newName.Contains(" "))
            {
                FrostyMessageBox.Show("Name contains invalid characters.", "League Logo Duplicator");
                return;
            }
            ...
            {
                FrostyMessageBox.Show("New name must be different from the source.", "League Logo Duplicator");
                return;
            }
            ...
            {
                FrostyMessageBox.Show("Select a destination folder in the tree.", "League Logo Duplicator");
                return;
            }

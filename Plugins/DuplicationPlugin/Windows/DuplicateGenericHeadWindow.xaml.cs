...
{
    public partial class DuplicateGenericHeadWindow : FrostyDockableWindow
    {
        public string NewHeadName { get; private set; }
        public string DestinationPath { get; private set; }

        private readonly string sourceFolder;

        public DuplicateGenericHeadWindow(string inSourceFolder)
        {
            InitializeComponent();
        ...
        private void DuplicateButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                FrostyMessageBox.Show("New name cannot be empty.", "Generic Head Duplicator");
                return;
            }

            if (newName.Contains("//") || newName.Contains(" "))
            {
                FrostyMessageBox.Show("Name contains invalid characters.", "Generic Head Duplicator");
                return;
            }
            ...
            {
                FrostyMessageBox.Show("New name must be different from the source.", "Generic Head Duplicator");
                return;
            }
            ...
            {
                FrostyMessageBox.Show("Select a destination folder in the tree.", "Generic Head Duplicator");
                return;
            }
